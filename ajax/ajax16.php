...
<html>
    <head>
        ...
        <script async>
            ...
            async function lerDados() {
                return await fetch("http://localhost/flores3/listagem-json2.php")
            ...
            async function confirmar() {
                ...
                const resultado = await fetch("http://localhost/flores3/cadastro-json2.php", {
                    method: "POST",
                    headers: {
            ...
            async function excluir() {
                ...
                const resultado = await fetch("http://localhost/flores3/excluir.php", {
                    method: "POST",
                    headers: {
                        "Content-type": "application/json"
                    },
    ...
    <body>
        ...
        <form action="../flores3/logout.php" method="POST">
